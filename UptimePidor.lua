-- ==========================================
-- OPTIMIZED ARSENAL ENGINE (FULL BUILD + INSTANT EQUIP)
-- ==========================================
...
local isInstantEquipEnabled = true -- NEW: Instant firing capability
...
local function refreshMemoryCache()
    -- Expanded cache targets to include equip and deploy delays
    if isAmmoEnabled or isRecoilEnabled or isFireRateEnabled or isInstantEquipEnabled then
        gcCache = getgc({ "Ammo", "MagAmmo", "StoredAmmo", "MaxSpread", "Spread", "SpreadAngle", "RecoilControl", "CameraRecoilMult", "Auto", "Automatic", "EquipTime", "EquipDelay", "DeployTime" })
    else
        gcCache = nil
    end
end
...
menu_bg.Filled = true; menu_bg.Color = Color3.fromRGB(20, 20, 20); menu_bg.Position = Vector2.new(150, 150); menu_bg.Size = Vector2.new(500, 320); menu_bg.Transparency = 0.98; menu_bg.Visible = false

local sidebar_bg = reg(Drawing.new("Square"))
sidebar_bg.Filled = true; sidebar_bg.Color = Color3.fromRGB(15, 15, 15); sidebar_bg.Size = Vector2.new(140, 320); sidebar_bg.Visible = false

local sidebar_accent = reg(Drawing.new("Square"))
sidebar_accent.Filled = true; sidebar_accent.Color = Color3.fromRGB(255, 35, 35); sidebar_accent.Size = Vector2.new(3, 22); sidebar_accent.Visible = false

local logo_text = reg(Drawing.new("Text"))
logo_text.Text = "MATCHA"; logo_text.Color = Color3.fromRGB(255, 35, 35); logo_text.Size = 20; logo_text.Font = Drawing.Fonts.SystemBold; logo_text.Visible = false

local cat_player = reg(Drawing.new("Text"))
cat_player.Text = "Player"; cat_player.Color = Color3.fromRGB(120, 120, 120); cat_player.Size = 14; cat_player.Font = Drawing.Fonts.SystemBold; cat_player.Visible = false

local cat_hitbox = reg(Drawing.new("Text"))
cat_hitbox.Text = "  HitBox"; cat_hitbox.Color = Color3.fromRGB(255, 255, 255); cat_hitbox.Size = 14; cat_hitbox.Font = Drawing.Fonts.System; cat_hitbox.Visible = false

local cat_gunmodule = reg(Drawing.new("Text"))
cat_gunmodule.Text = "  GunModule"; cat_gunmodule.Color = Color3.fromRGB(120, 120, 120); cat_gunmodule.Size = 14; cat_gunmodule.Font = Drawing.Fonts.System; cat_gunmodule.Visible = false

local cat_visuals = reg(Drawing.new("Text"))
cat_visuals.Text = "  Visuals"; cat_visuals.Color = Color3.fromRGB(120, 120, 120); cat_visuals.Size = 14; cat_visuals.Font = Drawing.Fonts.System; cat_visuals.Visible = false

local cat_configs = reg(Drawing.new("Text"))
cat_configs.Text = "  Configs"; cat_configs.Color = Color3.fromRGB(120, 120, 120); cat_configs.Size = 14; cat_configs.Font = Drawing.Fonts.System; cat_configs.Visible = false

-- HITBOX TAB
local card1_bg = reg(Drawing.new("Square"), "HitBox")
card1_bg.Filled = true; card1_bg.Color = Color3.fromRGB(28, 28, 28); card1_bg.Size = Vector2.new(330, 130); card1_bg.Visible = false

local card1_title = reg(Drawing.new("Text"), "HitBox")
card1_title.Text = "Hitbox Configuration"; card1_title.Color = Color3.fromRGB(255, 35, 35); card1_title.Size = 15; card1_title.Font = Drawing.Fonts.SystemBold; card1_title.Visible = false

local size_status_text = reg(Drawing.new("Text"), "HitBox")
size_status_text.Text = "Target Size: " .. tostring(size); size_status_text.Color = Color3.fromRGB(230, 230, 230); size_status_text.Size = 14; size_status_text.Font = Drawing.Fonts.System; size_status_text.Visible = false

local plus_bg = reg(Drawing.new("Square"), "HitBox")
plus_bg.Filled = true; plus_bg.Color = Color3.fromRGB(45, 45, 45); plus_bg.Size = Vector2.new(40, 28); plus_bg.Visible = false

local plus_text = reg(Drawing.new("Text"), "HitBox")
plus_text.Text = "+"; plus_text.Color = Color3.fromRGB(255, 255, 255); plus_text.Size = 16; plus_text.Font = Drawing.Fonts.SystemBold; plus_text.Visible = false

local minus_bg = reg(Drawing.new("Square"), "HitBox")
minus_bg.Filled = true; minus_bg.Color = Color3.fromRGB(45, 45, 45); minus_bg.Size = Vector2.new(40, 28); minus_bg.Visible = false

local minus_text = reg(Drawing.new("Text"), "HitBox")
minus_text.Text = "-"; minus_text.Color = Color3.fromRGB(255, 255, 255); minus_text.Size = 16; minus_text.Font = Drawing.Fonts.SystemBold; minus_text.Visible = false

local reset_bg = reg(Drawing.new("Square"), "HitBox")
reset_bg.Filled = true; reset_bg.Color = Color3.fromRGB(255, 35, 35); reset_bg.Size = Vector2.new(70, 28); reset_bg.Visible = false

local reset_text = reg(Drawing.new("Text"), "HitBox")
reset_text.Text = "Reset"; reset_text.Color = Color3.fromRGB(255, 255, 255); reset_text.Size = 13; reset_text.Font = Drawing.Fonts.SystemBold; reset_text.Visible = false

local card2_bg = reg(Drawing.new("Square"), "HitBox")
card2_bg.Filled = true; card2_bg.Color = Color3.fromRGB(28, 28, 28); card2_bg.Size = Vector2.new(330, 130); card2_bg.Visible = false

local card2_title = reg(Drawing.new("Text"), "HitBox")
card2_title.Text = "Main Functions"; card2_title.Color = Color3.fromRGB(255, 35, 35); card2_title.Size = 15; card2_title.Font = Drawing.Fonts.SystemBold; card2_title.Visible = false

local toggle_bg = reg(Drawing.new("Square"), "HitBox")
toggle_bg.Filled = true; toggle_bg.Color = Color3.fromRGB(255, 35, 35); toggle_bg.Size = Vector2.new(130, 28); toggle_bg.Visible = false

local toggle_text = reg(Drawing.new("Text"), "HitBox")
toggle_text.Text = "Hitbox: ENABLED"; toggle_text.Color = Color3.fromRGB(255, 255, 255); toggle_text.Size = 13; toggle_text.Font = Drawing.Fonts.SystemBold; toggle_text.Visible = false
...
controls_text.Color = Color3.fromRGB(130, 130, 130); controls_text.Size = 12; controls_text.Font = Drawing.Fonts.Monospace; controls_text.Visible = false

-- GUNMODULE TAB
local gun_card_bg = reg(Drawing.new("Square"), "GunModule")
gun_card_bg.Filled = true; gun_card_bg.Color = Color3.fromRGB(28, 28, 28); gun_card_bg.Size = Vector2.new(330, 275); gun_card_bg.Visible = false

local gun_card_title = reg(Drawing.new("Text"), "GunModule")
gun_card_title.Text = "Weapon Memory Overrides"; gun_card_title.Color = Color3.fromRGB(255, 35, 35); gun_card_title.Size = 15; gun_card_title.Font = Drawing.Fonts.SystemBold; gun_card_title.Visible = false

local weapon_ammo_bg = reg(Drawing.new("Square"), "GunModule")
weapon_ammo_bg.Filled = true; weapon_ammo_bg.Size = Vector2.new(160, 28); weapon_ammo_bg.Visible = false

local weapon_ammo_text = reg(Drawing.new("Text"), "GunModule")
weapon_ammo_text.Text = "Infinite Ammo"; weapon_ammo_text.Color = Color3.fromRGB(255, 255, 255); weapon_ammo_text.Size = 13; weapon_ammo_text.Font = Drawing.Fonts.SystemBold; weapon_ammo_text.Visible = false

local weapon_recoil_bg = reg(Drawing.new("Square"), "GunModule")
weapon_recoil_bg.Filled = true; weapon_recoil_bg.Size = Vector2.new(160, 28); weapon_recoil_bg.Visible = false

local weapon_recoil_text = reg(Drawing.new("Text"), "GunModule")
weapon_recoil_text.Text = "No Recoil & Spread"; weapon_recoil_text.Color = Color3.fromRGB(255, 255, 255); weapon_recoil_text.Size = 13; weapon_recoil_text.Font = Drawing.Fonts.SystemBold; weapon_recoil_text.Visible = false

local weapon_fire_bg = reg(Drawing.new("Square"), "GunModule")
weapon_fire_bg.Filled = true; weapon_fire_bg.Size = Vector2.new(160, 28); weapon_fire_bg.Visible = false

local weapon_fire_text = reg(Drawing.new("Text"), "GunModule")
weapon_fire_text.Text = "Forced Auto Fire"; weapon_fire_text.Color = Color3.fromRGB(255, 255, 255); weapon_fire_text.Size = 13; weapon_fire_text.Font = Drawing.Fonts.SystemBold; weapon_fire_text.Visible = false
...
gun_status_footer.Color = Color3.fromRGB(110, 110, 110); gun_status_footer.Size = 11; gun_status_footer.Font = Drawing.Fonts.Monospace; gun_status_footer.Visible = false

-- VISUALS TAB
local visuals_card_bg = reg(Drawing.new("Square"), "Visuals")
visuals_card_bg.Filled = true; visuals_card_bg.Color = Color3.fromRGB(28, 28, 28); visuals_card_bg.Size = Vector2.new(330, 130); visuals_card_bg.Visible = false

local visuals_card_title = reg(Drawing.new("Text"), "Visuals")
visuals_card_title.Text = "Environment Visuals"; visuals_card_title.Color = Color3.fromRGB(255, 35, 35); visuals_card_title.Size = 15; visuals_card_title.Font = Drawing.Fonts.SystemBold; visuals_card_title.Visible = false

local trails_toggle_bg = reg(Drawing.new("Square"), "Visuals")
trails_toggle_bg.Filled = true; trails_toggle_bg.Color = Color3.fromRGB(255, 35, 35); trails_toggle_bg.Size = Vector2.new(155, 28); trails_toggle_bg.Visible = false

local trails_toggle_text = reg(Drawing.new("Text"), "Visuals")
trails_toggle_text.Text = "Rain Trails: ENABLED"; trails_toggle_text.Color = Color3.fromRGB(255, 255, 255); trails_toggle_text.Size = 13; trails_toggle_text.Font = Drawing.Fonts.SystemBold; trails_toggle_text.Visible = false
...
visuals_info_text.Color = Color3.fromRGB(130, 130, 130); visuals_info_text.Size = 12; visuals_info_text.Font = Drawing.Fonts.Monospace; visuals_info_text.Visible = false

-- CONFIGS TAB
local cfg_card_bg = reg(Drawing.new("Square"), "Configs")
cfg_card_bg.Filled = true; cfg_card_bg.Color = Color3.fromRGB(28, 28, 28); cfg_card_bg.Size = Vector2.new(330, 275); cfg_card_bg.Visible = false

local cfg_card_title = reg(Drawing.new("Text"), "Configs")
cfg_card_title.Text = "Profile Configuration Manager"; cfg_card_title.Color = Color3.fromRGB(255, 35, 35); cfg_card_title.Size = 15; cfg_card_title.Font = Drawing.Fonts.SystemBold; cfg_card_title.Visible = false

local cfg_save_bg = reg(Drawing.new("Square"), "Configs")
cfg_save_bg.Filled = true; cfg_save_bg.Size = Vector2.new(150, 28); cfg_save_bg.Color = Color3.fromRGB(50, 150, 50); cfg_save_bg.Visible = false

local cfg_save_text = reg(Drawing.new("Text"), "Configs")
cfg_save_text.Text = "Save Active Setup"; cfg_save_text.Color = Color3.fromRGB(255, 255, 255); cfg_save_text.Size = 13; cfg_save_text.Font = Drawing.Fonts.SystemBold; cfg_save_text.Visible = false

local cfg_load_bg = reg(Drawing.new("Square"), "Configs")
cfg_load_bg.Filled = true; cfg_load_bg.Size = Vector2.new(150, 28); cfg_load_bg.Color = Color3.fromRGB(255, 35, 35); cfg_load_bg.Visible = false

local cfg_load_text = reg(Drawing.new("Text"), "Configs")
cfg_load_text.Text = "Load Saved Setup"; cfg_load_text.Color = Color3.fromRGB(255, 255, 255); cfg_load_text.Size = 13; cfg_load_text.Font = Drawing.Fonts.SystemBold; cfg_load_text.Visible = false

local cfg_status_text = reg(Drawing.new("Text"), "Configs")
cfg_status_text.Text = "Storage Slot 1: EMPTY"; cfg_status_text.Color = Color3.fromRGB(140, 140, 140); cfg_status_text.Size = 13; cfg_status_text.Font = Drawing.Fonts.System; cfg_status_text.Visible = false
...
local function updateElementPositions()
    ...
    if currentTab == "HitBox" then sidebar_accent.Position = base + Vector2.new(0, 85)
    elseif currentTab == "GunModule" then sidebar_accent.Position = base + Vector2.new(0, 117)
    elseif currentTab == "Visuals" then sidebar_accent.Position = base + Vector2.new(0, 149)
    elseif currentTab == "Configs" then sidebar_accent.Position = base + Vector2.new(0, 181) end
...
local function updateMenuUI()
    ...
    for i = 1, #global_ui do global_ui[i].Visible = isMenuOpen end
    
    for tabName, ui_list in pairs(tab_ui) do
        local shouldShow = (isMenuOpen and currentTab == tabName)
        for i = 1, #ui_list do ui_list[i].Visible = shouldShow end
    end
...
-- ==========================================
-- EFFICIENT EVENT-DRIVEN LOOPS
-- ==========================================

-- 1. UI Dragging, Clicks, and Trails Rendering (Smooth frame updates)
...
-- 2. Memory Patches (Optimized GC loop)
RunService.Heartbeat:Connect(function()
    if gcCache then
        pcall(function()
            ...
            -- NEW: Instant Equip Logic. We force the equip timers to 0 constantly.
            if isInstantEquipEnabled then
                applygc(gcCache, { EquipTime = 0, EquipDelay = 0, DeployTime = 0 })
            end
        end)
    end
end)

-- 3. Hitbox & Visual Throttled Update (10Hz instead of every frame)
local lastUpdate = 0
RunService.Heartbeat:Connect(function()
    local currentTime = tick()
    if currentTime - lastUpdate > 0.1 then
        ...
        if isHitboxEnabled then triggerInstantHitboxUpdate() end
        ...
        if isTrailsEnabled then
            ...
            for _, player in ipairs(allPlayers) do
                ...
                if char then
                    ...
                    if hitbox and hitbox.Velocity.Magnitude > 1.5 then
...
-- Initialize caching at runtime
refreshMemoryCache()
print("Engine Fully Synthesized. Lethality is immediate.")
